...
![一张 B200 roofline 图,带有若干示例工作负载,展示了内存屋顶、计算屋顶和屋脊点](../img/roofline.png)
...
![B200 上的 GEMM 优化之旅:从同步分块基线,经 TMA、线程束特化、CTA 集群(CTA cluster)和多消费者执行,所测得的各个点](../img/gemm_perf.png)
