...
![cta_group::1,M=128:第 m 行直接映射到 TMEM Lane m](../img/zh/mma_cg1_m128.svg)
...
![cta_group::1,M=64:四段 16 行,以 Lane 步长 32 排布,为另一个对齐的 M=64 分块留出空间](../img/zh/mma_cg1_m64.svg)
...
![cta_group::2,M=256:M 连续拆分到两个 CTA,每个 CTA 128 行](../img/zh/mma_cg2_m256.svg)
...
![cta_group::2,M=128:每个 CTA 64 行 M,N 的两半分别叠放在 Lane 的下半与上半](../img/zh/mma_cg2_m128.svg)
...
![块缩放 MMA 放置:A 与 B 打包在 SMEM;SFA、SFB 与 C 在 TMEM,其中 SFA 按 M 拆分到各 CTA,SFB 在这对 CTA 间组播](../img/zh/mma_block_scaled.svg)
